...
for timeRange_ms in enumerate(
    [ # timestamps for slices are in milliseconds -- I got them
      ...
      ((6  * 60 + 14) * 1000, (6  * 60 + 43.5) * 1000), # 02 (modified 3/4)
      ...
      ((32 * 60 + 22) * 1000, (33 * 60 + 22) * 1000), # 15 (original)
      ...
      ((33 * 60 +  6) * 1000, (35 * 60 + 18) * 1000), # 16 (original)
      ...
      ((36 * 60 + 42) * 1000, (36 * 60 + 50.5) * 1000), # 17 (modified 3/20)
      ...
      ((41 * 60 + 59) * 1000, (42 * 60 + 13) * 1000), # 19 (original)
      ...
      ((42 * 60 + 55) * 1000, (43 * 60 + 10) * 1000), # 19 (original)
      ((43 * 60 + 10) * 1000, (43 * 60 + 16) * 1000), # 19 (original)
      ...
      ((45 * 60 + 37.25) * 1000, (47 * 60 + 45.5) * 1000), # 19 (original)
      ((45 * 60 + 45.5) * 1000, (47 * 60 + 13) * 1000), # 19 (original)
      ...
      ((46 * 60 + 36.2) * 1000, (46 * 60 + 53) * 1000), # 19 (original)
